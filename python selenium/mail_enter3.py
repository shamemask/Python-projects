...
username = 'vezde.svoe@gmail.com'
password = 'Ty073kl!'
mail_server = 'imap.gmail.com'
imap_server = imaplib.IMAP4_SSL(host=mail_server,port=993)
...
# Case sensitive!
imap_server.select('[Gmail]/&BB4EQgQ,BEAEMAQyBDsENQQ9BD0ESwQ1-')  # Default is `INBOX`
